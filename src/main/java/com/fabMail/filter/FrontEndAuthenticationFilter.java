...
public class FrontEndAuthenticationFilter implements Filter {
    ...
    private static final String[] loginRequiredURLs = {
    	"UpdateServletExc","/logout","/supprimermessageExec","/supprimermessageFrom","/EmailSendingForm", "/EmailSendingServlet", "/Sent","/Inbox"
    };
...
//        }
        ...
        //System.out.print("-----------"+session.getAttribute("usernamelogin"));
        String loginURI = httpRequest.getContextPath() + "loginformservlet";
